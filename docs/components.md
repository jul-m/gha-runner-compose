...
| Component Name | Override | Categories | Content | Prebuilt Image | Build x64 | Build ARM64 | Run x64 | Run ARM64 | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| `codeql-bundle` | No | `other` | [github/codeql-action](https://github.com/github/codeql-action) | `xlarge+` |  | ✅ |  |  | Build ARM64 OK but the pkg appears targeted at AMD64, no post-install tests → needs tests on ARM64 |
| `container-tools` | No | `container` | [containers/podman](https://github.com/containers/podman), [containers/buildah](https://github.com/containers/buildah), [containers/skopeo](https://github.com/containers/skopeo) | `medium+`, `container` |  | ❌ |  |  |  |
...
- **Build / Run**: Component availability and compatibility by hardware architecture.
  - `x64`: x86_64 / AMD64 architecture.
